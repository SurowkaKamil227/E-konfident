...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/account` | `/account` | `/(tabs)/add` | `/add` | `/(tabs)/administration` | `/administration` | `/(tabs)/changePassword` | `/changePassword` | `/(tabs)/faq` | `/faq` | `/(tabs)/` | `/(tabs)` | `/(tabs)/legalInfo` | `/legalInfo` | `/(tabs)/modifyData` | `/modifyData` | `/(tabs)/myAcc` | `/myAcc` | `/(tabs)/showData` | `/showData` | `/(tabs)/_layout` | `/_layout` | `/login` | `/register`;
  // prettier-ignore
